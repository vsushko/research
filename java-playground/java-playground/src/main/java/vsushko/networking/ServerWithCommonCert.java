 ...
 * @author vsushko
 */
public class ServerWithCommonCert {

    private static final String passphrase = "serverpw";
    private final SSLContext sslContext;

    // constructor with port
    public ServerWithCommonCert() throws GeneralSecurityException, IOException {
        ...
        clientKeyStore.load(new FileInputStream("server.public"), "public".toCharArray());
    ...
    public static void main(String args[]) throws GeneralSecurityException, IOException {
        ServerWithCommonCert server = new ServerWithCommonCert();
