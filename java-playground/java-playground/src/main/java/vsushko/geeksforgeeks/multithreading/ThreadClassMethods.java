...
class Test implements Runnable {
    ...
    public static void main(String[] args) {
        Test obj = new Test();
        ThreadClassMethods obj2 = new ThreadClassMethods();
        ...
        Thread thread3 = new Thread(new ThreadClassMethods());
        ...
        ThreadGroup group = thread1.getThreadGroup();
        System.out.println("ThreadGroup to which thread1 belongs " + group.toString());
